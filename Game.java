...
public class Game 
{
    ...
    private void createRooms()
    {
        ...
        //Items
        mazmorra.addItem("Manzana", "Manzana", 0.12F, true);
        mazmorra.addItem("Llave", "Llave", 0.05F, true);
        mazmorra.addItem("Martillo", "Martillo", 9.95F, true);
        mazmorra.addItem("Piedra", "Piedra", 9.95F, false);
